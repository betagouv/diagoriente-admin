...
class TooltipForm extends React.Component<Props, State> {
  state = {
    comp1: (this.props.theme.tooltips && this.props.theme.tooltips[0]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[0]._id
    },
    comp2: (this.props.theme.tooltips && this.props.theme.tooltips[1]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[1]._id
    },
    comp3: (this.props.theme.tooltips && this.props.theme.tooltips[2]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[2]._id
    },
    comp4: (this.props.theme.tooltips && this.props.theme.tooltips[3]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[3]._id
    },
    comp5: (this.props.theme.tooltips && this.props.theme.tooltips[4]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[4]._id
    },
    comp6: (this.props.theme.tooltips && this.props.theme.tooltips[5]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[5]._id
    },
    comp7: (this.props.theme.tooltips && this.props.theme.tooltips[6]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[6]._id
    },
    comp8: (this.props.theme.tooltips && this.props.theme.tooltips[7]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[7]._id
    },
    comp9: (this.props.theme.tooltips && this.props.theme.tooltips[8]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[8]._id
    },
    comp10: (this.props.theme.tooltips && this.props.theme.tooltips[9]) || {
      ...
      tooltip: "", _id: this.props.theme.tooltips && this.props.theme.tooltips[9]._id
    }
  };
  handleChange1 = (e: any) => {
