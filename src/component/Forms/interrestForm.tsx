...
interface Props {
  onSubmitHandler(params: { nom: string; rank: string }): void;
  header?: string;
  submitText?: string;
  classes: any;
  nom?: string;
...
class CreateInterrest extends React.Component<Props> {
  state = {
    submit: false,
    errorForRank: false,
    errorForName: false,
    nameValue: this.props.nom || '',
...
export interface InterestFormComponent extends CreateInterrest {}

export default withStyles(styles)(CreateInterrest);
